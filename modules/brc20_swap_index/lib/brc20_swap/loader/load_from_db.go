...
`, strings.Join(conds, " AND "))
	...
	for rows.Next() {
		...
		err := rows.Scan(&moduleId, &tick, &pkscript, &balance.SwapAccountBalance, &balance.AvailableBalance, &balance.ApproveableBalance, &balance.CondApproveableBalance, &balance.WithdrawableBalance)
		if err != nil {
