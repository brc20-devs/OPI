...
const MODULE_SWAP_SOURCE_INSCRIPTION_ID = "93ce120ff87364c261a534fea4c39196a615f449412fb3547a185d92306a39b8i0"
...
var (
	...
	TICKS_ENABLED = os.Getenv("TICKS_ENABLED")
)

func init() {
	if is_testnet != "" {
		GlobalNetParams = &chaincfg.TestNet3Params
	}
}
